...
public class InteractibleManager : Singleton<InteractibleManager>
{
    ...
    void Update()
    {
        ...
        if (FocusedGameObject != oldFocusedGameObject)
        {
            ...
            {
                if (FocusedGameObject.GetComponent<Interactible>() != null || FocusedGameObject.GetComponent<UIBoxInteractible>() != null)
                {
    ...
    private void ResetFocusedInteractible()
    {
        ...
        {
            if (oldFocusedGameObject.GetComponent<Interactible>() != null || oldFocusedGameObject.GetComponent<UIBoxInteractible>() != null)
            {
