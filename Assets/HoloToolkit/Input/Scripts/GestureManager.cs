...
public class GestureManager : Singleton<GestureManager>
{
    ...
    private void ManipulationRecognizer_ManipulationStartedEvent(InteractionSourceKind source, Vector3 position, Ray ray)
    {
        ...
        //if (AircraftHand.Instance.FocusedGameObject != null)
        //{
        //    IsManipulating = true;

        //    ManipulationPosition = position;

        //    AircraftHand.Instance.FocusedGameObject.SendMessageUpwards("PerformManipulationStart", position);
        //}
    }
    ...
    private void ManipulationRecognizer_ManipulationUpdatedEvent(InteractionSourceKind source, Vector3 position, Ray ray)
    {
        ...
        //    AircraftHand.Instance.FocusedGameObject.SendMessageUpwards("PerformManipulationUpdate", position);
        //}
    }
